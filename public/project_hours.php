...
<div class="mt-4 p-3 border rounded bg-white">
    ...
    <?php
        $totalDia = array_sum(array_map('count', $funcionarios));

        $minEsperadoDia = count($funcionarios) * 2;
        $maxEsperadoDia = count($funcionarios) * 4;

        $erroDia = !($totalDia == $minEsperadoDia || $totalDia == $maxEsperadoDia);
        ...
        <a data-bs-toggle="collapse"
           ...
           style="text-decoration: none; color: inherit;">
            <div class="card-header d-flex justify-content-between">
                ...
                <span class="<?= $erroDia ? 'text-danger fw-bold' : 'text-muted' ?>">
                    <?= $totalDia ?> registros
        ...
        <div class="collapse" id="d<?= $date ?>">
            <div class="card-body">
                ...
                <?php foreach ($funcionarios as $funcName => $eventosDoFunc): ?>
                    ...
                    <div class="card mb-2 <?= $temErro ? 'border-danger' : '' ?>">
                        <a data-bs-toggle="collapse"
